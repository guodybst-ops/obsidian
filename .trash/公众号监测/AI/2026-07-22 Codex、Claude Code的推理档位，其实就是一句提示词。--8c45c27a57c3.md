...
公众号: "Datawhale"
发布日期: 2026-07-22
抓取时间: 2026-07-23 10:37:46
类别: AI
自动检查结果: "B 存参考资料"
相关度评分: 10
命中词: ["AI", "大模型", "学习"]
原始链接: "https://mp.weixin.qq.com/s/Rf32OCWDM-mf1ocfKKQbUw"
文章ID: "2247724447_1"
---
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cSiblfh7OJg4ibWyv35j0l1NjLDgb8spIh6X9SBw2jRpCmREn6WWXEI4lH2JQxSBGsNq6x9RKibAKib9PS80wZmicHOh5UQWrx0LWN0E/640?wx_fmt=png&from=appmsg)

Sebastian Raschka 的        这篇文章就把推理档位讲清楚了，把它从你看    到的下拉菜单，一直讲到训练管线里那行 reward。看完你会发现，档位不是玄学。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/zW6S9vt0cSibnictzd4rgDXbot3HZ8icCZ4cDORbEVkbZW0xPZw7U3xhiah9weOgAguicJOBmSz6tA5bzCnHJ0ffMpECqWa69ibZ23tnia2WmDedzI/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cSicUFAvnFYzfCFy5hKwL1uic5bPRtwicKo1I7HHYxPibGFrbSpmS0twcgHQl5rf2mbFHNZUSlWicRdDtQk4nwiba0FQO1H9M3uWI1gPs/640?wx_fmt=png&from=appmsg)

只靠「奖励结果」这一条，模型自己学会了写中间步骤、回头检查、发现错了再改。这种「等一下，这里好像不对」的瞬间，被叫做 Aha moment。

##   三    、<think>    标签  是装饰性的，对推理能力本身没有贡献
你可能在模型输出里见过    <think></think>   。很容易以为是这对标签让模型「开始思考」的。并不是。

![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cSicmwqTVtee2icianLBRleWxQ2OMSg0c63RQLKJNzk6IjECz1FyKZngxaHxFYOwXGqraksrlxYgecHuQRlOBeh06ibbWAJg8pEUMkQ/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cS85JIzQb6FpVhgHut7VCZArLVC3ic2eh9RlNpS1Jx4zY2QNZWaBUvBibTqvmria2L0oD3aBwibibyt2q0iagOEyqiaMmWibtM6dsQ7OuZc/640?wx_fmt=png&from=appmsg)

再简单的问题，第一代推理模型也要啰嗦一大段。       Qwen3 这类后来的模型开始做混合：同一个模型，既能当普通指令助手，也能按需切成推理模式。Qwen3 用     enable_thinking=True/False    控制，关掉时的实现其实是在回答开头塞一个空的    <think></think>   ，让模型直接跳到答案。这套开关是在一个叫 Thinking Mode Fusion 的训练阶段里学出来的。

##  五、推理档位，本质上是往 system prompt 里塞了一句话
到了 GPT-5、GPT-5.6 这一代，开关从「开/关」变成了 low / medium / high / max 这样的多档。

![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cSibgCcoBbG9Cs1W5DvicKBjEKKJrwaDQpnOQrzO4B0E6bibyvOhBIKjPN1AcfW74YuwbtmM34dFWOdVdT6PdH9iacYibwmrfe1BO4Gs/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/zW6S9vt0cSibmpltRrE12GaDB86gl4nRMYtfn58Bwalz8rDTXGBXwjubicUh9cXjlfA1QMjCcm6zOdckComnKtNXF7FuGjWlnUNTpEPuiaUEvc/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/zW6S9vt0cS9dvNicTVcjXicI7KvO7OllJbjyKECVdMo5I9eAzLeicLbon9InhYTEo1AvbV72NK3DoLZTcYjPicmcqfxzHCrBv4Sksy9OmvkIIyw/640?wx_fmt=png&from=appmsg)

选模型和调档位对应两个不同的 scaling 轴：前者换的是权重本身，后者只改推理时花掉的算力。      有意思的是这两条曲线会重叠：一个小模型开高档，有时能追平一个大模型开低档的分数。

![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cSib0rLicuicdtdY4aubJIiaMrkoc79VyjZ3edFT7uOyyH87hpohu7TJAfpQ8GNZu2oNTxcSqDmtlS1M1ZzIjicZ7RWiagubx7a6LCZps/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cS9o5NSWC3ddj0rrz43Wdt3Ol63jNwiatxmJCxSecbiaVvVh1n59VPgPAb3JBAulQTIzkDLiaicTR5XFlK0TAtCPgMOSVXAtB3ibTeP0/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/zW6S9vt0cSibH8Brv1aBRhujdYxEsRfRrx42VjS1ZjfYmDakSnJesyWZDWLF3lSfHolZLoBbr7cH9hPfBhDYcP2X3K4X4sEnH38wbwqbua0w/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zW6S9vt0cS8iaQgG9Wvac5UwAmNT9JX38ib3WYa1eAW2MwDf30rwoP7QF7UNu4vxqZnzQdGibBfmBwttibQricvxXLHh31lDVRuhic0WYIjASK6IQ/640?wx_fmt=png&from=appmsg)
...
- 公众号：Datawhale
- [查看微信原文](https://mp.weixin.qq.com/s/Rf32OCWDM-mf1ocfKKQbUw)

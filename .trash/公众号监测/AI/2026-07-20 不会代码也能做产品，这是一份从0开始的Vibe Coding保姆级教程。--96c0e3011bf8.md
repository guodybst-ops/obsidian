...
公众号: "数字生命卡兹克"
发布日期: 2026-07-20
抓取时间: 2026-07-20 10:51:41
类别: AI
自动检查结果: "B 存参考资料"
相关度评分: 10
命中词: ["AI", "大模型", "学习"]
原始链接: "https://mp.weixin.qq.com/s/EeHjsju08ARLbwtwFcViqg"
文章ID: "2647684477_1"
---
...
2.8T的Kimi K3，2.4T的Qwen 3.8 Max，而在未来，肉眼可见的，还有马上上线的DeepSeek V4正式版，还有Seed、GLM、MiMo、LongCat等等要到来的更大规模的版本。

我觉得，这就是所有在国内，想用AI搓一个自己的产品、所有想把自己想法变成现实的人，最好的黄金岁月。

现在，你不需要捏着鼻子用海外的模型了，考虑到对面封号、考虑到魔法、考虑付费等等，你可以直起身来，用我们自己的模型，来做你自己想做的东西。

包括我自己搓的产品AIHOT，从5月发布开始，到今天，2个多月的时间，最近一周的周活终于过了30万，月活也正式过了60万。

所以，我觉得今天，我也可以分享一下，作为一个纯外行，如果你想从0开始，用国产模型，徒手搓出一个完全属于自己的产品，应该需要哪些步骤和流程，还有一些乱七八糟的坑。
...
Kimi、GLM、Qwen等等都无所谓，能买到哪个就用哪个，差距没有你想象的大。

2. 去下载各家官方的Agent编程产品。

买了Coding Plan之后，去下载各家官方的Agent编程产品。

ZCode、Qoder、Kimi Code等等，你买了哪家的Coding Plan就用哪家的，因为未来肯定是自家的Agent更适合自家的大模型，可以提前用了。虽然现在很多的Harness还是不如Claude Code，但是我觉得会很快的补上。

![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqVwyI4ic6S8UCpDvicwSY6Z2afgJLtib017iakR7jJs51GlYIvrS8XkspoW9LNOOPXH6QJPl2yUqjhOemykwiadIP1BMmwMOf6V5GP8/640?wx_fmt=png&from=appmsg)

3. 想好你的产品名字。

很多人觉得名字随便起一个就行了，做完再改。

但不是这样的，你后面所有的东西，logo、域名、备案、小程序名称、App Store上架，全都跟名字绑定，改名的成本比你想象的大一百倍。
...
去火山引擎、腾讯云、阿里云啥的都可以，去域名注册页面，搜你想要的域名。

![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqWY1iajVLfOVic63sM5MVIu0UIegv80uZNVeD4c6LKHbLGd9lVhDzmqicUKSpVOnVLJ8QibQJnKSTY1tX2YOVTJQauIAHp8kuj2oHE/640?wx_fmt=png&from=appmsg)

我自己就是在这一步吃了亏，AIHOT当时真的就是随便取的，然后后面没想到这玩意做起来了，结果一查，AIHOT.com这个域名，是我可能永远都买不起的程度。。。

5. 买一台服务器。

你的产品做出来之后，它得有一个地方运行，不能跑在你自己电脑上，你电脑一关，全世界都访问不了了。

为了让整套教程拥有一条统一、直观的路径，所以我们下面都以以云服务器为例，部分静态网站和轻量产品也可以使用Serverless、云开发或托管平台啥的，不一定需要自己维护服务器。

不过现在维护服务器因为有了Agent之后，维护已经很简单了。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqX1OVUMR1aduIGMCxYwZ40sbf0uYbLibHgTib7Ts6IMFtmsgREUuCdMd1wIUzgiarxy4foNQvgWONGsiaAXAOvM9fl5dYNCzHibB4go/640?wx_fmt=png&from=appmsg)

买服务器这里，推荐一下腾讯云上的服务器，新客一般都有大优惠，一年一个轻量的可能才99或者199，轻度产品使用足够了，不知道配置怎么选，就直接截图问你的AI，告诉它你想做什么产品，让它帮你挑。

当然，最好的方式，就是让Agent操控你的浏览器，直接帮你选。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqXP7ib0hEibtIHvoGbrR8tzdHlV4JNICJKkicZ3CFx5QDIXmEYrBQ9CTWch9nxKlUkiasdaxKBx5JS4s1RqP0ZlIk6VC4oib21Kl910/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqWvJNH7XAAxYkDEKVKLiahpuPPG6ZCtrl5SKYfVTpicwzlDEWE9WGrIbseqRwAyc1YVffIcmfhC6hLxCYLIdjzNceDDofQUs0jKQ/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqU0rIcIvDkfQ1ibtVjBGxKzAKsCZSSQScSwVZSHm7At1OttHsxiaxIF0gzYZvqJyzDicA9Jd7kK4Ypt4lUIGgKRpJGLxPXwibhT9AY/640?wx_fmt=png&from=appmsg)

9. 注册一个GitHub账号。

GitHub是全球最大的代码托管平台。

你的代码不能只存在你自己电脑上，万一硬盘坏了、电脑丢了，你什么都没了。

所以，可以注册一个GitHub账号（免费的），让Agent帮你连接上你的GitHub账号，然后把你的代码推到GitHub上的一个私有仓库里，注意是私有仓库，不是公开的。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqVDGicnHrLTjMAM76SPtbkYCR1cngsjACJKpEoPbEicTaVaZ9yTibkqrlTI8qx9Id2WOh5bqThXUrOZDsmmk5x0LZw1menbIgEu3I/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqW39b6a34RwRmAtI4mTZWv1pshcsmicxEjxDsIiaDxiaicC7ckhmicjD5SGZ9Uk5tGk4uvxuT7ibjWPrFaWCglaST3TCWsaEk0ENhJ94/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqXQ1xQeEdto41Xj3sFic04Q9zsRbDVsLzKWarPExVx5U8icUzlTfbEIAnUae0YFyPjnklgYRSicrXpfich4jQeliaWq7MKZPE0F7SD8/640?wx_fmt=png&from=appmsg)
...
这是我自己做的一个Vibe Coding专用Skill，也是我如今用得最多的skill。

![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqWnE8HenVr7TKbyW08AranrphXGkyrgt6ywJZwDgDXYAYrqMB0AiatuPcmoeyX3XIzmHhL32Ul7QHBanibcLxDE1AVBRlRMI87UE/640?wx_fmt=png&from=appmsg)

你在前面的开发过程中，可能跟AI聊了很多轮，改了很多东西，你的代码和文档大概率已经有点乱了，甚至会出现自相矛盾的情况。

这个时候，就是洁癖.skill的作用了，专门干一件事，就是把你的项目文档、代码规则、AI记忆文件全部规范化整理一遍。

![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqXzojVFvVloGLWRkPZyibbwLzryp2J7hNia0xYdteXxnGiaLt0YxSytTevO8vur4Y5krfUibWKjMrtnz2WlAVQvgnEVCoOLicKcWwwQ/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/2jjfQoZLoqXZOM6DVeGBygmXzgibeQaB05Qo2UqzTDcLOL98wMaD2v7tGeIVBa3Smz1YUJGedpj6ykqWAgvccQWO7pqDJEATyXJEXG7aqoLA/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/2jjfQoZLoqUjaZPQicicPNe4rg5Uz5mVkaNyRDSqsu0hNMerMwSzEfuXDMwIdfWcX986YibzBrOcG8D41Jw5fAECrOkntSGkXeDDHuwTSibGm3Y/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=14)
...
每一个前端页面背后对应的是哪个接口，每一个后端接口做了什么事情，你的数据库有哪些表，每张表里存了哪些字段，这些字段是怎么被用到的，用户点了一个按钮之后数据是怎么流转的。
...
- 公众号：数字生命卡兹克
- [查看微信原文](https://mp.weixin.qq.com/s/EeHjsju08ARLbwtwFcViqg)

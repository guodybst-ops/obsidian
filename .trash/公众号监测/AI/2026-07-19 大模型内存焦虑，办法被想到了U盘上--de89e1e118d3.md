---
title: "大模型内存焦虑，办法被想到了U盘上"
公众号: "量子位"
发布日期: 2026-07-19
抓取时间: 2026-07-19 23:49:04
类别: AI
自动检查结果: "B 存参考资料"
相关度评分: 10
命中词: ["AI", "大模型"]
原始链接: "https://mp.weixin.qq.com/s/FVzAQSdfhrXw2IOhHWF0lA"
文章ID: "2247905034_2"
---
...
葛文婷 发自 凹非寺
量子位 | 公众号 QbitAI    不是，Flash不是很慢吗？SanDisk和SK海力士怎么拿它喂大模型了？？？
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGaxyhQVic7bqoicOC1bWib9M6f1MK1qLvyyPOpmTvrCRtHJ9Bnjr6Dm8Ao7VKqeIquZyawbKDrlMkGLQBF9OxTqDLvZNXqbqE2R4/640?wx_fmt=png&from=appmsg)

但现在，SanDisk和SK海力士正在推动一种新东西：   High Bandwidth Flash（高带宽闪存）   ，   简称HBF。

它的思路很直接：把HBM（高带宽内存）那套先进封装和芯片堆叠的方法，搬到NAND Flash上。

换句话说，就是   让原本负责存东西的闪存，也能参与到AI推理的高速数据供给里。

![图片](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEDzHAMvDrzsJcVIqLqzRRajaUFRMIULDyF9zCXpMDxrKeU4MlvQeOVLRTpxgsIqnaGKOdWDG92vJJIDGDicK5bWPzOUzxERhsQ/640?wx_fmt=png&from=appmsg)

根据SanDisk公开资料，HBF预计可以堆叠最多   16颗   NAND Flash芯片，目标   单个堆栈容量最高可达512GB   ，   目标读取带宽最高可达1.6TB/s   。

后续第二代、第三代路线图里，读取带宽还会进一步提升到  2TB/s  和  3.2TB/s  。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGVLm71MkWb5wmlblZH6F3TiauGz0wibzHgh8icp1em5j0GvOIl9Xzf5G4BbQic507hKLVB0tb6ib3W6KLibY6Q6j3GIPuuW6vZiaA5V8/640?wx_fmt=png&from=appmsg)

但关键在于，Flash慢，主要慢在写入。

NAND Flash通过浮栅晶体管里的电荷来存储数据，并按块和页进行组织。这种机制使其断电后仍能保留数据，无需像DRAM那样不断刷新，因此   天然适合长期存储，兼具高密度与低成本的优势。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHdNbNRYe5RdZC3CHxUVic1ticiaJHTRAFteVptQcqDweUPZvNqiaDSEZZrBgPDDcVh9RJSHSYYtEsuFIov5lZTW7PIIXicYjpngTQ8/640?wx_fmt=png&from=appmsg)

按最新ONFI 6.0闪存接口标准，   单颗die理论带宽最高可以到4.8GB/s。

单看这个数字，确实不算夸张。

但   DDR5单条DIMM最高可到70.4GB/s   ，   HBM4E单堆栈更是能到3.6TB/s   ，和单颗NAND闪存芯片相比大约是   750倍   量级差距。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGExWrUoVTGiaaDSjDMwRKl34q900YHPXoSz57uoMSibxsA9jhRJIgiahw8T9B2o3W8FibR9FRiciaKMVamlNqvp0iappIjLOKN2IdEpro/640?wx_fmt=png&from=appmsg)
...
HBM   继续负责最紧急、最频繁的高速计算数据交换。

HBF   则负责装下那些体量巨大、但不怎么改动的模型参数。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFpXYIfPsnHFAUeP1FIKeibtmLGyS02DGHLLLVd2yPUeXrpozCJJY6vUYFhIN9Uqb2rgCAELpPPcnJ0GHTY8IRuYhicXwasmQjZ8/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGGicggBbsom5GSX5pV80byOJgcmbYJuTQpWtmuJ2njSn8su4XgGwcq4ia81MT5qRJZqIZbUer74mI4O7xgQRtVIoekZW1cJjQib0/640?wx_fmt=png&from=appmsg)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGE1Qic9U0VH5O7kCiaszVY2zXSQvxz5NZeXV4BA5GQMTnGK1Rdd3D5nvMB3ue0umdNQQMaTA6sdW5hVT2tYFlwCtq6pzTrnOMkRQ/640?wx_fmt=png&from=appmsg)

让   HBM   负责极致性能，   HBF   负责大容量高带宽读取，   SSD   负责更低成本的大规模存储。
...
从U盘、SD卡里的NAND Flash，到AI服务器里的高带宽模型权重池，听起来跨度很大，但   大模型的问题已经很清楚：参数越来越多，推理越来越贵，HBM越来越紧。
...
- 公众号：量子位
- [查看微信原文](https://mp.weixin.qq.com/s/FVzAQSdfhrXw2IOhHWF0lA)
